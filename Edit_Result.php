...
<html>
  <head>
    ...
    <title>Edit Results-Reporting Sys.</title>
    ...
    <meta property="og:title" content="Edit Resultf">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav nav-pills mx-auto mb-lg-0 fw-bolder fs-6">
        ...
        <div class="container">
            <form method="post">
                <p class="text-center shadow rounded heading">Edit Results Information</p>
                ...
                <div style="margin: 20px;">
                    <fieldset class="form-group">
                        <input style="margin-left: 43%" class="btn btn-primary shadow" type="submit" name="details" value="ENTER DETAILS">
                    </fieldset>
                </div>
            </form>
        </div>
        ...
        <div id="table">
            <span id="allStaff">EDIT STUDENT RESULTS HERE:</span>
            <table class="table table-striped table-primary">
                ...
                <!-- PHP CODE (IF STATEMENT) THAT WILL CHECK THE CLASS, YEAR AND TERM THE USER SELECTED AND POPULATE THE RECORDS INTO THE TABLE (LIKE THE EXAMPLE ABOVE) FOLLOWS HERE. -->
        
            </table>

            <div style="margin: 20px;">
                    <fieldset class="form-group">
                        <input style="margin-left: 43%" class="btn btn-primary shadow" type="submit" name="details" value="UPDATE RESULTS">
                    </fieldset>
                </div>
        </div>
