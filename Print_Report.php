...
<html>
  <head>
    ...
    <title>Print Report-Reporting Sys.</title>
    ...
    <meta property="og:title" content="Print Report">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav nav-pills mx-auto mb-lg-0 fw-bolder fs-6">
        ...
        <div class="container">
            <form method="post">
                <p class="text-center shadow rounded heading">Print Terminal Reports</p>
                ...
                <div style="margin: 20px;">
                    <fieldset class="form-group">
                        <input style="margin-left: 43%" class="btn btn-primary shadow" type="submit" name="generateReport" value="GENERATE REPORT">
                    </fieldset>
                </div>
            </form>
        </div>
        ...
        <div id="table">
            <span id="allStaff">STUDENTS TERMINAL REPORT:</span>

                <!-- PHP CODE THAT WILL CHECK THE CLASS, YEAR AND TERM THE USER SELECTED AND POPULATE THE REPORT FOR THE STUDENT FOLLOWS HERE. -->
        
            

            <div style="margin: 20px;">
                    <fieldset class="form-group">
                        <input style="margin-left: 43%" class="btn btn-primary shadow" type="submit" name="printReport" value="PRINT REPORT">
                    </fieldset>
                </div>
        </div>
